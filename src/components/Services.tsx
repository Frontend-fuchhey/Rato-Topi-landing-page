          ...
          {content.services.items.map((service, index) => (
            ...
            >
              ...
              <div className="absolute -bottom-10 -right-10 w-48 h-48 opacity-[0.08] pointer-events-none">
                <img src="/icon-hat.png" alt={content.services.watermarkAlt} className="w-full h-full object-contain" style={{ filter: "sepia(1) hue-rotate(-50deg) saturate(5) opacity(0.3)" }} />
              </div>
            </motion.div>
          ))}
        </div>
